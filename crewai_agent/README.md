...
- Modify `src/crewai_agent/config/agents.yaml` to define your agents
- Modify `src/crewai_agent/config/tasks.yaml` to define your tasks
- Modify `src/crewai_agent/crew.py` to add your own logic, tools and specific args
- Modify `src/crewai_agent/main.py` to add custom inputs for your agents and tasks
...
This command initializes the crewai-agent Crew, assembling the agents and assigning them tasks as defined in your configuration.
